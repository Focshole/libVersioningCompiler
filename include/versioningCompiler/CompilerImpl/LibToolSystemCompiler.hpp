 ...
 */
#ifndef LIB_VERSIONING_LIBTOOL_COMPILER_SYSTEM_COMPILER_HPP
#define LIB_VERSIONING_LIBTOOL_COMPILER_SYSTEM_COMPILER_HPP
...
class LibToolSystemCompiler : public SystemCompiler {
  using SystemCompiler::SystemCompiler;
