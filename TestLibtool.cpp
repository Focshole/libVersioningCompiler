...
int main(int argc, char const *argv[]) {
  ...
  vc::compiler_ptr_t cc = vc::make_compiler<vc::LibToolSystemCompiler>();
  ...
  vc::compiler_ptr_t gcc = vc::make_compiler<vc::LibToolSystemCompiler>(
      "gcc", std::filesystem::u8path("gcc"), std::filesystem::u8path("."),
      std::filesystem::u8path("./test_libtool.log"),
  ...
  vc::compiler_ptr_t clang =
      vc::make_compiler<vc::LibToolSystemCompilerOptimizer>(
  ...
  vc::compiler_ptr_t clangAsLib = vc::make_compiler<vc::ClangLibCompiler>(
      ...
      std::filesystem::u8path("test_libtool_clang.log"));
#endif
